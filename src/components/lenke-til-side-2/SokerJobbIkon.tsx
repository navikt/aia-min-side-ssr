    ...
    <svg width='48' height='48' viewBox='0 0 48 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <g clipPath={`url(${id})`}>
        ...
        <path
          ...
          strokeWidth='1.5'
        />
        <path d='M14 36.5L14 40.5' stroke='#23262A' strokeWidth='1.5' strokeLinecap='round' />
        <circle cx='43' cy='5' r='4.25' stroke='#23262A' strokeWidth='1.5' />
        <circle cx='1' cy='1' r='1' transform='matrix(1 0 0 -1 35 4)' stroke='#23262A' strokeWidth='1.5' />
        <circle cx='29' cy='5' r='4.25' stroke='#23262A' strokeWidth='1.5' />
        <path
